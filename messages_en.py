messages_en = {
    ...
    'help': """
        ...
        /getplot - Get weekly mood dynamics
    ...
    'after_plot': "It may seem unnecessary to track your mood, but many people find it hard to remember how they felt on any given day or during the week: it all blends together. Mood trackers like this help you reflect and monitor your overall state of mind.\nIt's worth noting that whatever method of mood tracking is used, it's all about increasing awareness.\nWe can change our lives or support ourselves in new ways by tracking how mood changes at different times of the day and depending on different events. Let health care become more comprehensive and diverse 💚",
}
